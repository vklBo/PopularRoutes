...
var overlays = require('./config/overlays.js');
...
$(document).ready(function (e) {
    ...
    $.when(ghRequest.fetchTranslationMap(urlParams.locale), ghRequest.getInfo())
            .then(function (arg1, arg2) {
                ...
                function createWeightingButton(weighting, hide) {
                    var button = $("<button class='vehicle-btn' title='" + translate.tr(weighting) + "'/>");
                    if (hide)
                        button.hide();
                ...
                function createSlider(param, hide, min, max, step, value) {
                    var slider = $("<input class='weighting-param' type='range' />");
                    if (hide)
                    	slider.hide();

                    slider.attr('id', param);
                    slider.attr('min', min);
                    slider.attr('max', max);
                    slider.attr('step', step);
                    slider.attr('value', value);
                    ghRequest.initRoutingParam(param, value);
                ...
                if (json.features) {
                    ...
                    var prefer = {"car": 1, "foot": 2, "bike": 3, "popular_motorcycle": 9999, "motorcycle": 10000};
                    ...
                    var wbtn = createWeightingButton("fastest", false);
                    vehiclesDiv.append(wbtn);
                    wbtn = createWeightingButton("curvature", false);
                    vehiclesDiv.append(wbtn);
                    wbtn = createWeightingButton("popular", false);
                    vehiclesDiv.append(wbtn);
                    
                    wbtn = createSlider("avoid_motorway", false, -5, 10, 1, 0);
                    vehiclesDiv.append(wbtn);
                    wbtn = createSlider("avoid_primary", false, -5, 10, 1, 0);
                    vehiclesDiv.append(wbtn);
                    wbtn = createSlider("avoid_secondary", false, -5, 10,  1, 0);
                    vehiclesDiv.append(wbtn);
                    wbtn = createSlider("avoid_tertiary", false, -5, 10, 1, 0);
                    vehiclesDiv.append(wbtn);
                    wbtn = createSlider("avoid_residential", false, -5, 10, 1, 0);
                    vehiclesDiv.append(wbtn);

                    
                    wbtn = createSlider("prefer_curved", false, 0, 16, 4, 0);
                    vehiclesDiv.append(wbtn);
                    wbtn = createSlider("prefer_popular", false, 0, 16, 4, 0);
                    vehiclesDiv.append(wbtn);
